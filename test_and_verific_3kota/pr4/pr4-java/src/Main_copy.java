...
public class Main_copy {
        ...
        try {
            ...
            if (temp_var == 1) {
                ...
                if (temp_scan.hasNextDouble()) {
                    ...
                    // ОШИБКА 2: Логическая ошибка - неправильная формула
                    double res_temp_F = (temp_C * 9/5) - 32; // Должно быть +32
            ...
            // ОШИБКА 3: Неправильная обработка исключений - проглаживание без логирования
            System.out.println("Ошибка: введите целое число для выбора варианта!");
            // Пропущен вызов temp_scan.next() для очистки некорректного ввода
        }
    }

    // ОШИБКА 4: Бесконечная рекурсия (ошибка управления памятью/стеком)
    public static void recursiveMethod(int count) {
        System.out.println("Рекурсивный вызов: " + count);
        // Отсутствует условие выхода из рекурсии
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("5 - Тест рекурсии\t0 - Выход");
            ...
            try {
                ...
                switch (category) {
                    ...
                    case 3 -> mass();
                    case 4 -> length();
                    case 5 -> recursiveMethod(1); // ОШИБКА 4: Вызов метода с бесконечной рекурсией
                    case 0 -> {
